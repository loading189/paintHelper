...
const matchesCase = (
  ...
  if (definition.minValue !== undefined && value < definition.minValue) return false;
  if (definition.maxValue !== undefined && value > definition.maxValue) return false;

  if (definition.minChroma !== undefined && chroma < definition.minChroma) return false;
  if (definition.maxChroma !== undefined && chroma > definition.maxChroma) return false;
